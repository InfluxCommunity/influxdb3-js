...
const ignoredReferencePackages = [
  '!' /* ts&js builtin types */,
  '@influxdata/influxdb3-client!~__global' /*ignore global symbol declaration in packages/core/src/observable/symbol.ts */,
]
const mappedReferences = {
  // defect in api-extractor naming https://github.com/microsoft/rushstack/issues/3629
  '@influxdata/influxdb3-client!FLUX_VALUE':
    '@influxdata/influxdb3-client!FLUX_VALUE:var',
}
